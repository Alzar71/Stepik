...
try: 
    ...
    input4 = browser.find_element_by_class_name("second_block .form-control.first")
    input4.send_keys("123321")
    input5 = browser.find_element_by_class_name("second_block .form-control.second")
    input5.send_keys("www:\leningrad\spb.ru")
